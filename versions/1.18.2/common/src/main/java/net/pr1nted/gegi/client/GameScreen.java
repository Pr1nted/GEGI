...
public final class GameScreen extends Screen {
    ...
    @Override
    protected void init() {
        this.addRenderableWidget(new Button(2, 1, 60, 20, Lang.text("gegi.game.back"), b -> this.onClose()));
        this.addRenderableWidget(new Button(this.width - 112, 1, 110, 20, Lang.text("gegi.game.browser"), b -> {
