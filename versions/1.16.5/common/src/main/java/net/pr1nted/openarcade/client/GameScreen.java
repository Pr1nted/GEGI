...
public final class GameScreen extends Screen {
    ...
    @Override
    protected void init() {
        this.addButton(new Button(2, 1, 60, 20, Lang.text("openarcade.game.back"), b -> this.onClose()));
        this.addButton(new Button(this.width - 112, 1, 110, 20, Lang.text("openarcade.game.browser"), b -> {
