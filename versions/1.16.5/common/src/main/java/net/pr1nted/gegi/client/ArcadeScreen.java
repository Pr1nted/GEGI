...
public final class ArcadeScreen extends Screen {
    ...
    protected void init() {
        ...
        this.addButton(link);
        this.addButton(new Button(right - OPEN_LINK_WIDTH, FIELDS_Y - 1, OPEN_LINK_WIDTH, 20, Lang.text("gegi.link.open"), b -> model.takePasted().ifPresent(game -> ArcadeClient.play(this, game))));
