...
public final class CiMixinPlugin implements IMixinConfigPlugin {
    ...
    private static final boolean SELF_TEST = "1".equals(System.getenv("GEGI_SELFTEST"))
    ...
    public List<String> getMixins() {
        return SELF_TEST ? java.util.Collections.singletonList("McRuntimeTestMixin") : java.util.Collections.<String>emptyList();
    }
