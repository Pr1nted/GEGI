...
/**
 * What CI runs inside the real game when OPENARCADE_SELFTEST=1.
 *
 ...
 *
 * <p>MC-Runtime-Test joins a world for the test. With OPENARCADE_SELFTEST_CREATE_WORLD=1
...
final class SelfTest {
    ...
    private static void createWorldIfAsked(Minecraft minecraft) {
        ...
        minecraft.launchIntegratedServer(id, "Open Arcade self-test",
        ...
        try {
            ...
            switch (step) {
                ...
                case TYPE_COMMAND:
                    ...
                    chat.sendChatMessage("/arcade", false);
