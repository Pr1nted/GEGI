...
public final class ArcadeScreen extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        drawField(search, model.fieldHalf(this.width), Lang.string("gegi.search"));
        drawField(link, model.fieldHalf(this.width) - OPEN_LINK_WIDTH - ROW_GAP, Lang.string("gegi.link"));
