    ...
    static void tick(Minecraft minecraft) {
        ...
        try {
            ...
            switch (step) {
                ...
                break;
                case CLICK_BUTTON: {
                    if (screen instanceof OptionsScreen && screen instanceof OptionsButtonHolder) {
                        OptionsScreen options = (OptionsScreen) screen;
                        OptionsButtonHolder holder = (OptionsButtonHolder) (Object) screen;
