...
public final class GameScreen extends GuiScreen {
    ...
    protected void initGui() {
        this.buttons.clear();
        this.children.clear();
        this.addButton(Buttons.of(2, 1, 60, 20, Lang.string("gegi.game.back"), this::close));
        this.addButton(Buttons.of(this.width - 112, 1, 110, 20, Lang.string("gegi.game.browser"), () -> {
