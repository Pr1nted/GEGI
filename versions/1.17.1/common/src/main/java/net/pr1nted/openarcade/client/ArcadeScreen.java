...
public final class ArcadeScreen extends Screen {
    ...
    protected void init() {
        ...
        this.addRenderableWidget(new Button(right - OPEN_LINK_WIDTH, FIELDS_Y - 1, OPEN_LINK_WIDTH, 20, Lang.text("openarcade.link.open"), b -> model.takePasted().ifPresent(game -> ArcadeClient.play(this, game))));
