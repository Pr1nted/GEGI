...
/**
 * What CI runs inside the real game, on every loader, when GEGI_SELFTEST=1.
 *
    ...
    static void tick(Minecraft minecraft) {
        ...
        try {
            ...
            switch (step) {
                ...
                case TYPE_COMMAND -> {
                    minecraft.player.connection.sendCommand("gegi");
                ...
                case OPEN_OPTIONS -> {
                    minecraft.setScreen(new OptionsScreen(null, minecraft.options, true));
                ...
                case CLICK_BUTTON -> {
                    if (screen instanceof OptionsScreen options && options instanceof OptionsButtonHolder holder) {
                        ...
                        if (!button.mouseClicked(click, false)) fail("the GEGI button did not take a click");
